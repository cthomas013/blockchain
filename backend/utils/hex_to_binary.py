...
if __name__ == '__main__':
    ...
    print(f'hex_number number: {hex_number}')

    binary_number = hex_to_binary(hex_string=hex_number)
    print(f'binary_number number: {binary_number}')

    original_number = int(binary_number, 2)
    print(f'original_number number: {original_number}')
